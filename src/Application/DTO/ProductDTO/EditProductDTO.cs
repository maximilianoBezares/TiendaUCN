...
namespace TiendaUCN.src.Application.DTO.ProductDTO
{
    public class EditProductDTO
    {
        ...
        [MinLength(2, ErrorMessage = "El título debe tener al menos 3 caracteres.")]
        public required string Title { get; set; }

        [StringLength(100, ErrorMessage = "La descripción no puede exceder los 100 caracteres.")]
        [MinLength(0, ErrorMessage = "La descripción no puede ser menor a 0 caracteres.")]
        ...
        [StringLength(
            50,
            ErrorMessage = "El nombre de la marca no puede exceder los 50 caracteres."
        )]
